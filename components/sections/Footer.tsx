...
const socialLinks = [
  {
    href: "https://www.linkedin.com/company/dattaremit/home",
    label: "LinkedIn",
    icon: LinkedInIcon,
  },
  {
    href: "https://www.instagram.com/dattaremit",
    label: "Instagram",
    icon: InstagramIcon,
  },
];
            ...
            <ul className="space-y-3">
              {productLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-foreground/85 hover:text-[var(--brand-deep)] transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div className="flex items-center gap-1">
            {socialLinks.map((social) => (
              <a
                ...
                className="inline-flex size-8 items-center justify-center rounded-full text-muted-foreground hover:text-foreground hover:bg-foreground/5 transition-colors"
